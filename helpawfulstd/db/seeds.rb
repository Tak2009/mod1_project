...
r2 = Review.create(student_id: s2.id, student_own_level: 3, tutor_id: t5.id, language: t5.language, rating_for_tutor: 1, comment: "aaaa")
r3 = Review.create(student_id: s3.id, student_own_level: 3, tutor_id: t4.id, language: t4.language, rating_for_tutor: 2, comment: "feZC in general")
r4 = Review.create(student_id: s4.id, student_own_level: 5, tutor_id: t6.id, language: t6.language, rating_for_tutor: 3, comment: "jkood iffsneral")
r5 = Review.create(student_id: s4.id, student_own_level: 4, tutor_id: t7.id, language: t7.language, rating_for_tutor: 3, comment: "ehhhhod in general")
r6 = Review.create(student_id: s5.id, student_own_level: 2, tutor_id: t8.id, language: t8.language, rating_for_tutor: 4, comment: "qqod in gefral")
r7 = Review.create(student_id: s6.id, student_own_level: 2, tutor_id: t3.id, language: t3.language, rating_for_tutor: 3, comment: "oocsbiaveral")
...
r9 = Review.create(student_id: s7.id, student_own_level: 1, tutor_id: t2.id, language: t2.language, rating_for_tutor: 1, comment: "sfCSkncal")
...
r12 = Review.create(student_id: s3.id, student_own_level: 3, tutor_id: t11.id, language: t11.language, rating_for_tutor: 2, comment: "fvsveneral")
r13 = Review.create(student_id: s3.id, student_own_level: 3, tutor_id: t12.id, language: t12.language, rating_for_tutor: 2, comment: "fbbdeneral")